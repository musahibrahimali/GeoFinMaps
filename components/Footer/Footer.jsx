    ...
    return (
        <div className="pt-2 bg-white dark:bg-gray-900">
            <footer className="relative z-40 p-4 bg-white dark:bg-gray-900">
                <div className="bg-white dark:bg-gray-900 border-t border-b border-gray-200 dark:border-gray-700 py-16">
                        ...
                        <div className="lg:flex dark:bg-gray-900 bg-white">
                            <div className="w-full lg:w-1/2 mb-16 lg:mb-0 flex dark:bg-gray-900 bg-white">
                                ...
                                <div className="dark:bg-gray-900 bg-white w-full lg:w-1/2 px-6">
                                    <ul className="bg-white dark:bg-gray-900">
                                        <li className=" dark:bg-gray-900 bg-white">
                                            <Link href="/help">
                                                <a className="footer__item">
                                                    Help
                                                </a>
                                        ...
                                        <li className="mt-6 bg-white dark:bg-gray-900">
                                            <Link href="/help">
                                                <a className="footer__item">
                                                    FAQ
                                                </a>
                            ...
                            <div className="w-full lg:w-1/2 flex dark:bg-gray-900 bg-white">
                                ...
                                <div
                                    className="dark:bg-gray-900 bg-white w-full lg:w-1/2 px-6 flex flex-col justify-between">
                                    <div className="dark:bg-gray-900 bg-white flex items-center mb-6">
                                        <div
                                            ...
                                            <Link href="/">
                                                <a>
                                                    <svg
                                                        className="footer-icon text-gray-800 dark:text-gray-50 hover:text-gray-600 dark:hover:text-gray-400 feather feather-github"
                                        ...
                                        <div className="dark:bg-gray-900 bg-white pl-4">
                                            <Link href="/">
                                                <a>
                                                    <svg
                                                        className="footer-icon feather feather-twitter text-gray-800 dark:text-gray-50 hover:text-gray-600 dark:hover:text-gray-400 cursor-pointer"
                                                        xmlns="http://www.w3.org/2000/svg" width={24} height={24}
                                                        viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                        strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                                                        <path
                                    ...
                                    <div className="dark:bg-gray-900 bg-white relative w-12 cursor-pointer">
                                        <div
                                            className="bg-white dark:bg-gray-900 p-4 border border-solid rounded border-gray-400 dark:border-gray-100"
                                            onClick={handleTheme}>
                                            {theme && (
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                     className="absolute inset-0 m-auto ml-3 text-gray-700 dark:text-gray-50 hover:text-gray-600 dark:hover:text-gray-400  icon icon-tabler icon-tabler-brightness-up"
                                            ...
                                            {!theme && (
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                     className="absolute inset-0 m-auto ml-3 text-gray-700 dark:text-gray-50 hover:text-gray-600 dark:hover:text-gray-400 icon icon-tabler icon-tabler-moon"
                                                     width={20} height={20} viewBox="0 0 24 24" strokeWidth="1.5"
                                                     stroke="currentColor" fill="none" strokeLinecap="round"
                                                     strokeLinejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
